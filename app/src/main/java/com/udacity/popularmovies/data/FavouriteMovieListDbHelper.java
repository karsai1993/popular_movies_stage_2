...
public class FavouriteMovieListDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        final String SQL_CREATE_FAVOURITE_MOVIE_LIST_TABLE = "CREATE TABLE " +
                ...
                FavouriteMovieListContract.FavouriteMovieListEntry
                ...
                FavouriteMovieListContract.FavouriteMovieListEntry
                        .COLUMN_NAME_BACKDROP + " BLOB NOT NULL," +
                FavouriteMovieListContract.FavouriteMovieListEntry
                        .COLUMN_NAME_POSTER + " BLOB NOT NULL," +
                FavouriteMovieListContract.FavouriteMovieListEntry
                        .COLUMN_NAME_ORIGINAL_TITLE + " TEXT," +
                FavouriteMovieListContract.FavouriteMovieListEntry
                        .COLUMN_NAME_OVERVIEW + " TEXT NOT NULL," +
                FavouriteMovieListContract.FavouriteMovieListEntry
                        .COLUMN_NAME_AVERAGE_VOTE + " TEXT NOT NULL," +
                FavouriteMovieListContract.FavouriteMovieListEntry
